'''
Para hacerlo funcionar en la aplicación de Coursera:
python3.11 -m pip install pandas dash dash_html_components dash_core_components
...
'''
Codi base que dona l'aplicació:
# Import required libraries
import pandas as pd
import dash
